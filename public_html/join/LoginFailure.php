...
<title>Login Failed — Mythos Events</title>
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .status-card { background: var(--card); border: 1px solid rgba(220,80,80,0.4); border-radius: 14px; padding: 32px 36px; margin-bottom: 28px; }
  ...
  .form-note { margin-top: 20px; font-size: 13px; }
