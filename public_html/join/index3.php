...
<main>
  <div class="join-wrap">
    ...
    <div class="join-header">
      ...
      <p>Whether you perform, create, organize, or just show up with great energy — there's a place for you here.</p>
    </div>
    ...
    <div class="role-pills">
      ...
      <span class="pill">✨ Something Else</span>
    </div>
    ...
    <div class="form-card">
      <form action="email.php" method="post">
        ...
        <div class="field">
          <label for="role">How Do You Want to Be Involved?</label>
          <select id="role" name="role">
            <option value="">— Choose a role —</option>
            <option value="performer">Performer (improv, dance, music, acting)</option>
            <option value="artist">Artist or Maker</option>
        ...
        <div class="field">
          <label for="message">Tell Us a Little About Yourself <span style="color:var(--muted);font-size:11px;">(optional)</span></label>
          <textarea id="message" name="message" placeholder="What do you do, what are you excited about, what do you want to bring to Mythos Events?"></textarea>
        </div>

        <button type="submit" class="submit-btn">Join the Mythos ✦</button>
      </form>
      <p class="form-note">We'll be in touch soon. No spam, ever.</p>
    </div>
